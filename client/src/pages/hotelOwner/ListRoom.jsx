...
const ListRoom = () => {
  ...
  return (
    <div>
          <Title align='left' font='outfit' title='Room Listings' subTitle='View, edit and mange all the Listed rooms. Keep the information up-to-date to provide the best experience for the user.' />
          ...
          <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll mt-3'>
            ...
            <thead className='bg-gray-50'>
                      <tr>
                          <th className='px-4 text-gray-800 font-medium py-3'>Name</th>
                          <th className='px-4 text-gray-800 font-medium py-3 max-sm:hidden'>Facilities</th>
                          <th className='px-4 text-gray-800 font-medium py-3'>Price / night</th>
                          <th className='px-4 text-gray-800 font-medium py-3 text-center'>Action</th>
                      </tr>
                  </thead>    
               ...
               {rooms.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className='px-4 py-3 text-gray-700 border-t border-gray-300 max-sm:hidden'>{ item.amenities.join(',')}</td>
                       ...
                       <td className='px-4 py-3 text-red-500 border-t border-gray-300 text-center'>
