...
const ExclusiveOffers = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        ...
        <Title align='left' title="Exclusive Offers" subTitle="Take avvantage to our limited-time offers and special package to enhance your stay and create unforgatable memories." />  
