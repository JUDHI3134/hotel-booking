    ...
    <div className='fixed top-0 right-0 left-0 bottom-0 z-100 flex items-center justify-center bg-black/70'>
      ...
      {/* --------Phone----- */}
                  <div className='w-full mt-4'>
                      ...
                      <input type="phone" id='contact' placeholder='Type here' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
                  </div>
      {/* --------Address----- */}
                  <div className='w-full mt-4'>
                      <label htmlFor="address" className='font-medium text-gray-500'>Address</label>
                      <input type="phone" id='address' placeholder='Type here' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
                  </div>
