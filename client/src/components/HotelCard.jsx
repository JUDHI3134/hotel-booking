...
const HotelCard = ({room, index}) => {
  return (
    <Link to={'/rooms/'+ room._id} onClick={() => scrollTo(0,0)} key={room._id} className='max-w-70 relative w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[opx_4px_4px_rgba(0,0,0,0.05)]'>
